...
export function PatientEditSuccess() {
      ...
      <div className="w-full max-w-sm bg-white shadow-lg border border-gray-200 relative animate-slideUp">
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            {patientName}'s record (ID: <span className="font-semibold text-blue-600">{patientId}</span>) has been updated in the Yakap System
          </p>
